# 2025-11-22: 掲示板アプリが DNS 名でアクセスできない問題

## 🔍 問題

- デプロイワークフローは成功するが、DNS 名 `aksdemodevingress.japaneast.cloudapp.azure.com` でアクセスすると接続タイムアウト
- LoadBalancer IP `74.176.19.199` への直接アクセスは成功
- エラーメッセージ: `Failed to connect to aksdemodevingress.japaneast.cloudapp.azure.com port 80 after 21066 ms`
