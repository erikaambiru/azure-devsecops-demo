...
### フルデプロイ（Infra → Board → Admin）の合計時間

> Board App と Admin App は Infra 完了後に **並列実行** されます。

| シナリオ                       | Infra   | Board + Admin（並列） | 合計             |
| ------------------------------ | ------- | --------------------- | ---------------- |
| **最短（更新のみ）**           | 5 分    | 5 分                  | **約 10 分**     |
| **標準**                       | 5〜6 分 | 5〜8 分               | **約 15 分**     |
| **最長（初回 or フル再作成）** | 11 分   | 8 分                  | **約 19〜20 分** |

💡 **目安: フルデプロイで 15〜20 分、初回は最大 25 分程度**
